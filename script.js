document.addEventListener('DOMContentLoaded', () => {
    ...
    // Function to load scripts if consent is given
    const loadScripts = () => {
        // Load scripts with type="text/plain"
        document.querySelectorAll('script[type="text/plain"][data-cookie-category="analytics"]').forEach(script => {
    ...
    const checkConsent = () => {
        ...
        if (consent === 'accepted') {
            ...
            // Do nothing, scripts remain blocked
        } else {
